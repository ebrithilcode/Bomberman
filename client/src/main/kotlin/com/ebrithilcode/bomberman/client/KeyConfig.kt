...
class KeyConfig(private val keyToActionMap : Map<Char, PlayerAction>, private val keyCodeToActionMap : Map<Int, PlayerAction>) {
    ...
    companion object {
        val DEFAULT_CONFIG by lazy {KeyConfig(mapOf('w' to PlayerAction.UP, 's' to PlayerAction.DOWN, 'a' to PlayerAction.LEFT, 'd' to PlayerAction.RIGHT), mapOf(PConstants.SHIFT to PlayerAction.SWITCH))}
    }
